function [x_vect,k] = sol_sist_nonlin_3x3(F,x0,nmax)
% [x_vect,k] = sol_sist_nonlin_3x3(F,x0,nmax): Risolve sistemi di equazioni non lineari a bestemmie
%
...
x = subs(x0); x1 = x(1); x2 = x(2); x3 = x(3);
