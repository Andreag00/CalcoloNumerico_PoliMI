function [x, k, res_normalizzato] = richardson(A, b, P, x0, tol, nmax, alpha)
% [x, k, res_normalizzato] = richardson(A, b, P, x0, tol, nmax, alpha): Metodo di Richardson stazionario precondizionato o dinamico precondizionato (gradiente precondizionato)
% 
...
% res_normalizzato: residuo normalizzato
